...
export function UploadInwardPanel({
  title = 'Upload Inward Excel',
  description = 'Upload a new inward file. Old uploads remain unchanged as historical batches.',
}: Props) {
  ...
  return (
    <section className="rounded-3xl border border-neutral-200 bg-white p-6 shadow-sm">
      ...
      {message ? (
        <div className="mt-4 rounded-xl bg-neutral-100 p-3 text-sm">{message}</div>
      ) : null}
